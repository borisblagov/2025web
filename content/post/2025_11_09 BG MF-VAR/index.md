---
title: Monthly Bulgarian GDP 2025 Q2 (latest)
...
The current nowcast for Q3 for Bulgaria sits at a bit below 1% and the forecast for Q4 is at 0.6% growth rate. It includes the latest Eurostat publication for Q2 from the 06.09.2025 and monthly data up to 11th of September (I know, I know, I am sitting on these numbers for a while). Nevertheless I hope it can be of use for forecasters and the [Macroeconomic Forecast](BGMFVAR_250911.xlsx) round, although it is probably a bit too late for that.
